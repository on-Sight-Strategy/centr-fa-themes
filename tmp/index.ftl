...
[@helpers.html]
  ...
  [@helpers.body]
    ...
    [@helpers.footer]
      ...
      <div style="position:fixed; left:0; bottom: 0; margin-bottom: 7px; margin-left: 10px;"><a style="color: inherit;" href="https://the-praetorians.net" title="Escape is impossible when you're caught in the net.">π</a></div>
    [/@helpers.footer]
  [/@helpers.body]
[/@helpers.html]