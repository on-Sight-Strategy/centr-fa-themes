...
[@helpers.html]
  ...
  [/@helpers.head]
  [@helpers.body]
    [#-- VDB: Phone sent uses mainBoost with full background image --]
    [@helpers.mainBoost title="" subtitle="" rowClass="row center-xs" colClass="col-xs col-sm-8 col-md-6 col-lg-5 col-xl-4" showCoverImage=true showHeader=false titleClass=""]
      ...
      <div class="w-full text-left mb-6">
        <h2 class="font-degular-black vdb-title-white">${theme.message("phone-verification-sent-title-line1")!"CODE SENT"}</h2>
        <h2 class="font-degular-black vdb-title-brand">${theme.message("phone-verification-sent-title-line2")!"SUCCESSFULLY"}</h2>
      </div>
